    ...
    // Demo scope
    {
        ...
        std::unique_ptr<demo> Demos[] = 
        {
            ...
            */
            ...
            std::make_unique<demo_normal>(GLCache, GLDebug),
            ...
            std::make_unique<demo_hdr>(GLCache, GLDebug),
            std::make_unique<demo_PBR>(GLCache, GLDebug),

            std::make_unique<demo_mix>(GLCache, GLDebug),
        };
